...
module.exports = async (client, interaction) => {
    if (!interaction.isSelectMenu() || interaction.customId !== "channels_settings" || interaction.values[0] !== "complaints_channel") return;

    const embed = new MessageEmbed()
        .setDescription(`Please mention your complaints channel, or enter its ID`)
        .setColor("BLURPLE")
