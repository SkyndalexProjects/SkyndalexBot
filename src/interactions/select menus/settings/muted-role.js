...
module.exports = async (client, interaction) => {
    if (!interaction.isSelectMenu() || interaction.customId !== "roles_settings" || interaction.values[0] !== "muted_role") return;

    const embed = new MessageEmbed()
        .setDescription(`Please mention your muted role, or enter its ID`)
        .setColor("BLURPLE")
