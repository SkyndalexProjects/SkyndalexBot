...
module.exports = async (client, interaction) => {
    if (!interaction.isSelectMenu() || interaction.customId !== "channels_settings" || interaction.values[0] !== "suggestions_channel") return;

    const embed = new MessageEmbed()
        .setDescription(`Please mention your suggestions channel, or enter its ID`)
        .setColor("BLURPLE")
