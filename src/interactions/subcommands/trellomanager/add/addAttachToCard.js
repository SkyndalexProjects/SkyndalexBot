...
module.exports = async (client, interaction) => {
    const addAttachToCardModal = new Modal()
        .setTitle("Add attachment to card")
        .setCustomId("cardAttachAdd")
    ...
    await interaction.awaitModalSubmit({ filter, time: 15000 }).then(async interaction => {
        ...
        let messageConfirmEmbed2 = new MessageEmbed()
            ...
            .addField(`Card ID`, String(`${interaction.fields.getTextInputValue("cardAttachAdd_id")}`))
            .addField(`Attachment URL`, String(`${interaction.fields.getTextInputValue("cardAttachAdd_url")}`))
